...
def go_repositories_patches():
    go_repository(
        ...
        # there's no need to generate since it has its own BUILD file
        ...
        patch_args = ["-p1"],
        patches = ["//third_party:com_github_bazelbuild_remote_apis.patch"],
    )
...
def go_repositories():
    ...
    go_repository(
        ...
        sum = "h1:E31vxjCe6a5I+mJLmUGaZobiWmg9KdWaud9IfceYeYQ=",
        version = "v1.38.49",
    )
    go_repository(
        ...
        sum = "h1:L4/vUGbg1Xkw5L20LZD+hJI5I+ibWSytqQ68lTCfLwY=",
        version = "v55.0.0+incompatible",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:PwRKKVbCFzcGJ9WxctV6liI95GMiAneJrSFZTr6Za94=",
        version = "v0.19.6",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Om91PwKSOGiTE6bz0v7/Ho0232sxNxsbfeynYN2hy2o=",
        version = "v0.19.6",
    )
    go_repository(
        ...
        sum = "h1:ZtOoKjWEZP6BEuDd55B3sHTjneutv0z1oh3UfWiKxpc=",
        version = "v0.19.6",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:s8uNrZp42d2+TmTYjvzfkUbc7UM2xPn7JG+jyU4WqAg=",
        version = "v0.19.6",
    )
    go_repository(
        name = "io_k8s_cri_api",
        ...
        sum = "h1:YNZwcm1RJFCJWmLEtk7Ah5x7h9dpldxOiVEHMkj4eL0=",
        version = "v0.19.6",
    )
    go_repository(
        ...
        sum = "h1:dp+CjiqUpOZ7iNhSYyV+u/79FlPlh8kkDXXRNlZbKuE=",
        version = "v0.19.6",
    )
    go_repository(
        name = "io_k8s_gengo",
    ...
    go_repository(
        ...
        sum = "h1:huAkb9MZVN56gQ5fXe0eckFF6pbt167tPU6wkIMpiV8=",
        version = "v0.19.6",
    )
    go_repository(
        ...
        sum = "h1:nnW+b9rqPV/33xAnIGAhBRiEr4CEPE8+RUhD4bKEbGM=",
        version = "v0.19.6",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Zeo7gjnU0SsE9UzjW1buM+flv6LEheROmlKMaI4e0c0=",
        version = "v0.19.6",
    )
    go_repository(
        ...
        sum = "h1:pxIm1wcluoi1xquPJOvqj/M8Pc+zpb1ltkpZ7I+Pges=",
        version = "v0.19.6",
    )
    go_repository(
        name = "io_k8s_kubectl",
        ...
        sum = "h1:7FpynLRAyCuvVQtoV/bwwNKcwZTnprVHc6fui57KiRc=",
        version = "v0.19.6",
    )
    go_repository(
        name = "io_k8s_kubelet",
        ...
        sum = "h1:hVc1WLXnUBLGvweX1PAJZxsGHwawf2be7rK7M0h0KY8=",
        version = "v0.19.6",
    )
    go_repository(
        ...
        sum = "h1:weuFJOkRP7+057uvhNUYbVTVCog/klquhbtKRD+UHUo=",
        version = "v1.23.3",
    )
    go_repository(
        ...
        sum = "h1:5pozLmBjXHPtrPNB0Cn2pd3Azsh9XsX4pXWKspVuwyA=",
        version = "v0.19.6",
    )
    go_repository(
        name = "io_k8s_metrics",
        ...
        sum = "h1:2fBDib9hWUjV8PAoz4CltjXXBUdlUXonJvLgIo8W3mc=",
        version = "v0.19.6",
    )
    go_repository(
        ...
        sum = "h1:zPRPjS5rCOeEo4M6H5ysnwddVuYwEgJsiMgo2fgbPH0=",
        version = "v0.23.3",
    )
    go_repository(
        ...
        sum = "h1:YNCj5b+MF4nGzIZwUDHTdl7ktRq5vYGleI/brA30auY=",
        version = "v0.23.3",
    )
    go_repository(
        ...
        sum = "h1:duA1xqgMdCxDNUHrvanLJrd8vsQXJxKV7BZLDt1CnGc=",
        version = "v0.19.6",
    )
    go_repository(
